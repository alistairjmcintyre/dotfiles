# Generated by Powerlevel10k configuration wizard on 2020-04-27 at 20:13 NZST.
...
# 2 lines, solid, light-ornaments, sparse, many icons, fluent, transient_prompt,
...
() {
  ...
  #typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION='[%B@%m]'
  #typeset -g POWERLEVEL9k_CONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_CONTENT_EXPANSION='[%B@%m]'
  # Custom icon.
